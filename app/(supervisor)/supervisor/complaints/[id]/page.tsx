...
export default function SupervisorComplaintDetailPage() {
  ...
  if (error || !complaint) {
    return (
      <div className="flex flex-col items-center justify-center py-32 gap-3">
        ...
        <button onClick={() => router.push('/supervisor/queue')} className="text-sm text-indigo-600 hover:underline">← Back to Queue</button>
      </div>
    );
  }
  ...
  return (
    <div className="p-6">
      {/* Back */}
      <button onClick={() => router.push('/supervisor/queue')} className="flex items-center gap-2 text-sm text-gray-500 hover:text-indigo-600 mb-4">
